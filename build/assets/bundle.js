...
var smoothScroller = gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_2__.ScrollSmoother.create({
  smooth: 3,
  effects: true
...
var clients = document.querySelector('.clients-slider');

if (clients) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](clients, {
    spaceBetween: 30,
    slidesPerView: 'auto',
    navigation: {
